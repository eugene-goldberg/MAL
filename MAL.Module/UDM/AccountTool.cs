...
{
    // Register this entity in the DbContext using the "public DbSet<AccountTool> AccountTools { get; set; }" syntax.
    [DefaultClassOptions]
    ...
    public class AccountTool : IXafEntityObject, IObjectSpaceLink, INotifyPropertyChanged
    {
        public AccountTool()
        {
